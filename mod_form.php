...
/**
 * The main vidtrack configuration form
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_vidtrack_mod_form extends moodleform_mod {
    ...
    public function definition() {
        ...
        $mform->addElement('text', 'name', get_string('vidtrackname', 'vidtrack'), array('size' => '64'));
